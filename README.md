...
Автоматически обновляемая коллекция публичных VPN-конфигов (V2Ray / VLESS / Reality) для быстрого обхода блокировок.  
Каждый конфиг — это TXT-подписка, которую можно импортировать практически в любой современный клиент
(`v2rayNG`, `NekoRay`, `V2Box`, `Hiddify`, и др.).  

Конфиги обновляются каждые **9 минут** с помощью GitHub Actions, поэтому ссылки из раздела
«📋 Общий список всех вечно актуальных конфигов» всегда актуальны.
...
- [🗂️ Общее меню репозитория](#️-общее-меню-репозитория)
- [📜 Лицензия](#-лицензия)
- [💰 Поддержать автора](#-поддержать-автора)

## 🚀 Быстрый старт
1. Скопируйте нужную ссылку из раздела «Общий список…».  
...
_(Раздел в разработке — задавайте вопросы в [issues](../../issues) или обсуждениях проекта.)_
...
**1.** Скачиваем **v2rayNG** - [Ссылка](https://github.com/2dust/v2rayNG/releases/download/1.10.8/v2rayNG_1.10.8_universal.apk)
