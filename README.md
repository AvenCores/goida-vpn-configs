...
**3.** Нажимаем на **Сервер**, а затем **Добавить профиль из буфера обмена**.

**4.** Выделяем все конфиги комбинацией клавиш **Ctrl + A**, нажимаем **Профили** в верхнем меню, а затем **Тест задержки (пинга) выбранного профиля** и дожидаемся конца теста.

**5.** Наживаем на кнопку колонки **Задержка (пинг)**.

**6.** Выбираем один из конфигов с наименьшим **Задержка (пинг)**, а затем нажимаем **ЛКМ** и **Запустить**.
